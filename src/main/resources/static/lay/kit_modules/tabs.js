...
layui.define(["layer", "laytpl", "utils", "lodash", "route"], function (t) {
    ...
    v.prototype.set = function (t) {
        ...
        return f = void 0 === f ? i(c) : f, h = void 0 === h ? i('div.kit-tabs-content[kit-tabs="' + a + '"]') : h, u = void 0 === u ? i(s).children("ul") : u, f.children("li").each(function (t, n) {
            ...
            1 === o.length && o.off("click").on("click", function (t) {
                layui.stope(t), e.remove(r)
            }), i(s).find(".layui-close").off("click").on("click", function (t) {
                layui.stope(t);
                var n = i(this).parents(".kit-item").attr("lay-id");
                e.remove(n)
            })
        }), C.prevHandler(), C.nextHandler(), C.toolHandler(), C.toolBoxHandler(e), y || (y = !0, C.initCaches(e)), n.isFunction(t) && t({
            tabCount: i(c).children("li").length,
        ...
        if (void 0 === t.active) {
            ...
            if (a.existsByPath(t.path)) {
                ...
                return void a.switch(d.id)
            }
        } else {
            if (a.exists(t.id)) return void a.switch(t.id, !0);
            if (a.existsByPath(t.path)) {
                d = a.getByPath(t.path);
                return void a.switch(d.id, !0)
            }
        }
        e(p.TITLE).render(t, function (r) {
            f.append(r), e(p.CONTENT).render(t, function (r) {
                h.append(r), e(p.TOOLSITEM).render(t, function (e) {
                    ...
                    void 0 === o ? r.push({
                        ...
                        active: !0,
                        icon: t.icon
                    }) : o.id = t.id, C.setCaches(r), a.render(), void 0 === t.active ? a.switch(t.id) : t.active && a.switch(t.id, !0), n.isFunction(i) && i()
                })
            })
        })
        ...
        if (0 !== r.length) {
            ...
            if (void 0 !== s && s.active && i && (p(), r.click()), !i) {
                ...
                var h = n.find(c, function (t) {
                    return t.path === l
                });
                void 0 !== h && (h.active = !0), C.setCaches(c);
                var u = C.getContent(t);
                u.isRendered || C.renderHTMLForContent(u.elem, u.path)
            }
            n.isFunction(e.onChanged) && e.onChanged(t)
        }

        function p() {
            r.addClass("layui-this").siblings().removeClass("layui-this"), C.findContent(t).addClass("layui-show").siblings().removeClass("layui-show"), C.findTools(t).addClass("layui-this").siblings().removeClass("layui-this");
            var i = C.getContent(t);
            n.setUrlState(i.path, i.path)
        }
    }, v.prototype.switchByPath = function (t) {
        var i = C.findTitleByPath(t);
        i.length > 0 && this.switch(i.attr("lay-id"))
        ...
        return C.initCaches(this), this
    }, v.prototype.refresh = function (t) {
        t = t || C.getCurrId();
        var i = C.getContent(t);
        C.renderHTMLForContent(i.elem, i.path)
    };
    var C = {
                ...
                n.off("click").on("click", function () {
                    ...
                    switch (a) {
                        ...
                        case"refresh":
                            ...
                            break;
                        default:
                            var d = C.getContent(r);
                            d.isRendered || C.renderHTMLForContent(d.elem, d.path), t.switch(r)
                    }
                    i(s).hide()
                })
            })
